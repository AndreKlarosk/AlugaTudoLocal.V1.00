...
async function showOwnerProfileModal(ownerId) {
    ...
    modalContent.innerHTML = `<div class="p-8"><p>A carregar perfil...</p></div>`;
    showModal('ownerProfileModal');
    ...
    try {
        ...
        modalContent.innerHTML = `
            ...
            <button class="owner-profile-close-btn absolute top-4 right-4 text-gray-400 hover:text-gray-600 text-3xl">&times;</button>
        `;
...
['itemDetailModal', 'editItemModal', 'ownerProfileModal'].forEach(id => {
